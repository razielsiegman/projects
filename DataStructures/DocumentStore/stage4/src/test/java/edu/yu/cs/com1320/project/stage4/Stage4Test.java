...
public class Stage4Test {
    ...
    public void heapTest() throws Exception{
        ...
        List<String> limitList = store.search("pdf");
        assertEquals(6, limitList.size());
        assertEquals(true, limitList.contains(pdfTxt11));
        assertEquals(true, limitList.contains(pdfTxt10));
        assertEquals(true, limitList.contains(pdfTxt9));
        assertEquals(true, limitList.contains(pdfTxt8));
        ...
        assertEquals(true, limitListTwo.contains(pdfTxt11));
        assertEquals(true, limitListTwo.contains(pdfTxt10));
        store.setMaxDocumentBytes(10000);
        int returned6Repeat = store.putDocument(new ByteArrayInputStream(this.pdfData6), this.uri6, DocumentStore.DocumentFormat.PDF);
        int returned7Repeat = store.putDocument(new ByteArrayInputStream(this.pdfData7), this.uri7, DocumentStore.DocumentFormat.PDF);
        int returned8Repeat = store.putDocument(new ByteArrayInputStream(this.pdfData8), this.uri8, DocumentStore.DocumentFormat.PDF);
        int returned9Repeat = store.putDocument(new ByteArrayInputStream(this.pdfData9), this.uri9, DocumentStore.DocumentFormat.PDF);
        store.deleteAll("doc8");
        store.deleteAll("doc7");
        List<String> limitListThree = store.searchByPrefix("doc");
        assertEquals(4, limitListThree.size());
        assertEquals(true, limitListThree.contains(pdfTxt11));
        assertEquals(true, limitListThree.contains(pdfTxt10));
        assertEquals(true, limitListThree.contains(pdfTxt9));
        assertEquals(true, limitListThree.contains(pdfTxt6));
        store.undo();
        store.undo();
        List<String> limitListFour = store.searchByPrefix("doc");
        assertEquals(6, limitListFour.size());
        assertEquals(true, limitListFour.contains(pdfTxt11));
        assertEquals(true, limitListFour.contains(pdfTxt10));
        assertEquals(true, limitListFour.contains(pdfTxt9));
    ...
    public void test() throws IOException {
        ...
        store.setMaxDocumentCount(3);
        //only docs
        List<String> limitList = store.searchByPrefix("doc");
        assertEquals(3, limitList.size());
    }
